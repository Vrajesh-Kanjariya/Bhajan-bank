...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  void _onPreviousYearTap() {
    int currentPosition = _pageController!.page!.toInt();
    logs("current position $currentPosition");
          ...
          ValueListenableBuilder<DateTime>(
            ...
            builder: (context, value, _) {
              return CalendarHeader(
                ...
                focusedMonth: value,
                onPreviousMonthTap: _onLeftChevronTap,
                onNextMonthTap: _onRightChevronTap,
                onPreviousYearTap: _onPreviousYearTap,
                onNextYearTap: _onNextYearTap,
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final isWithinRange = widget.rangeStartDay != null &&
            ...
            _isWithinRange(day, widget.rangeStartDay!, widget.rangeEndDay ?? DateTime.now());

        final isRangeStart = isSameDay(day, widget.rangeStartDay ?? DateTime.now());
        final isRangeEnd = isSameDay(day, widget.rangeEndDay ?? DateTime.now());
        ...
        if (rangeHighlight != null) {
          ...
          // children.add(Center(child: SvgPicture.asset("assets/svg/ic_month_left.svg"),));
        }
  ...
  Widget _buildSingleMarker(DateTime day, T event, double markerSize) {
    return widget.calendarBuilders.singleMarkerBuilder?.call(context, day, event) ??
        SizedBox(
          ...
          child: Center(
            child: SvgPicture.asset("assets/svg/ic_badge_icon_active.svg"),
          ),
        );
  }
