...
class DaysOfWeekStyle {
  ...
  const DaysOfWeekStyle({
    ...
    this.weekdayStyle = const TextStyle(color: BhajanColorConstant.mandirColor,fontFamily: AppTheme.poppins,
        fontWeight: FontWeight.w600,fontSize:14),
    this.weekendStyle = const TextStyle(color: Color(0xFFE11B1B),fontFamily: AppTheme.poppins,
