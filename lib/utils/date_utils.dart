...
class DateTimeUtils {
  ...
  static String getPaymentFormattedDateTime(DateTime dateTime) {
  ...
  static String getDeliveryFormattedDateTime(DateTime dateTime) {
    final DateFormat formatter = DateFormat('dd MMM');
    return formatter.format(dateTime).toLowerCase();
  }

  static String getRefundProcessFormattedDateTime(DateTime dateTime) {
