import 'package:bank/pages/niyam_module/niyam/niyam_page.dart';
...
class SadgranthVanchanViewModel {
  late SadgranthVanchanPage sadgranthVanchanPage;
  ...
  SadgranthVanchanViewModel(this.sadgranthVanchanPage) {
