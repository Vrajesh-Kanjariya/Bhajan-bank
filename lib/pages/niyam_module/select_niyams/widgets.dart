...
Widget niyamSliverList(NiyamController controller) => SliverList(
      delegate: SliverChildBuilderDelegate(
        ...
        childCount: niyamViewModel!.subCategoryInfoList.length,
      ), //SliverChildBuildDelegate
    );

Widget demo(BuildContext context, NiyamController controller) => SliverList(
      delegate: SliverChildBuilderDelegate(
        (context, index) => Column(
          mainAxisSize: MainAxisSize.min,
          children: [
...
Widget buildSubCategoryView(BuildContext context, int index, NiyamController controller) {
  return Column(
    children: [
      ListView.builder(
        shrinkWrap: true,
        physics: const BouncingScrollPhysics(),
        itemCount: niyamViewModel!.subCategoryInfoList.first.subcategoryList.length,
        itemBuilder: (context, subIndex) {
          return InkWell(
            onTap: () {
              niyamViewModel!.onTapSubCategory(subIndex);
            },
            child: Padding(
              ...
              child: Container(
                  ...
                  height: 48.px,
                  decoration: BoxDecoration(
                    border: Border.all(color: BhajanColorConstant.lightYellow, width: 3.px),
                    ...
                    children: [
                        ...
                        child: Stack(
                          children: [
                            const AppImageAsset(
                              ...
                              color: BhajanColorConstant.lightYellow,
                            ),
                            Align(
                              alignment: Alignment.center,
                              child: Padding(
                      ...
                      Expanded(
                        child: AppText(
                          textAlign: TextAlign.center,
                          text: niyamViewModel!
                              .subCategoryInfoList.first.subcategoryList[subIndex].subCatName,
                          fontWeight: FontWeight.w700,
                          fontColor: BhajanColorConstant.black,
                          fontSize: 22.px,
                          letterSpacing: 0.75.px,
      ...
      Align(
        alignment: Alignment.centerLeft,
        child: Padding(
          padding: EdgeInsets.only(top: 15.px, bottom: 5.px, left: 10.px),
          child: Container(
            height: 31.px,
            width: 204.px,
            decoration: BoxDecoration(
                color: BhajanColorConstant.primary, borderRadius: BorderRadius.circular(8.px)),
            child: Center(
              child: AppText(
                textAlign: TextAlign.center,
                text: niyamViewModel!.categoryList[4].catName,
                fontSize: 16.px,
                fontWeight: FontWeight.w600,
      ...
      ListView.builder(
        shrinkWrap: true,
        physics: const BouncingScrollPhysics(),
        itemCount: niyamViewModel!.subCategoryInfoList[4].subcategoryList.length,
        itemBuilder: (context, subIndex) {
          return InkWell(
            onTap: () {
              niyamViewModel!.selectedIndex = 4;
              niyamViewModel!.onTapSubCategory(subIndex);
            },
            child: Padding(
              padding: EdgeInsets.only(left: 13.px, right: 13.px, top: 10.px),
              child: Container(
                  ...
                  height: 48.px,
                  decoration: BoxDecoration(
                    border: Border.all(color: BhajanColorConstant.lightPink, width: 3.px),
                    borderRadius: BorderRadius.circular(15.px),
                  ),
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Stack(
                          children: [
                            const AppImageAsset(
                                image: BhajanAssets.squareOne,
                                color: BhajanColorConstant.lightPink),
                            Align(
                              alignment: Alignment.center,
                              child: Padding(
                                padding: EdgeInsets.only(right: 5.px),
                      ...
                      Expanded(
                        child: AppText(
                          textAlign: TextAlign.center,
                          text: niyamViewModel!
                              .subCategoryInfoList[4].subcategoryList[subIndex].subCatName,
                          fontWeight: FontWeight.w700,
                          fontColor: BhajanColorConstant.black,
                          fontSize: 22.px,
                          letterSpacing: 0.75.px,
      ...
      Align(
        alignment: Alignment.centerLeft,
        child: Padding(
          padding: EdgeInsets.only(top: 15.px, left: 10.px),
          child: InkWell(
            onTap: () {
              niyamViewModel!.selectedIndex = 1;
              niyamViewModel!.sadgranthAnusthsan = !niyamViewModel!.sadgranthAnusthsan;
              controller.update();
            },
            child: Container(
              height: 31.px,
              ...
              child: Row(
                ...
                children: [
                  AppText(
                    textAlign: TextAlign.center,
                    text: niyamViewModel!.categoryList[1].catName,
                    fontSize: 16.px,
                    fontWeight: FontWeight.w600,
                    fontColor: BhajanColorConstant.white,
                  ),
                  Icon(
                    niyamViewModel!.sadgranthAnusthsan
      ...
      niyamViewModel!.sadgranthAnusthsan == true
          ? sadgranthanusthsanBodyuView()
          : const SizedBox(),
      Align(
        alignment: Alignment.centerLeft,
        child: Padding(
          ...
          child: InkWell(
            onTap: () {
              niyamViewModel!.selectedIndex = 2;
              niyamViewModel!.mukhPath = !niyamViewModel!.mukhPath;
              controller.update();
            },
            child: Container(
              height: 31.px,
              ...
              child: Row(
                ...
                children: [
                  AppText(
                    textAlign: TextAlign.center,
                    text: niyamViewModel!.categoryList[2].catName,
                    fontSize: 16.px,
                    fontWeight: FontWeight.w600,
                    fontColor: BhajanColorConstant.white,
                  ),
                  Icon(
                    niyamViewModel!.mukhPath ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                    color: BhajanColorConstant.white,
                  )
                ],
              ),
      ...
      niyamViewModel!.mukhPath == true
          ? mukhpathBodyView()
          : const SizedBox(),
      Align(
        alignment: Alignment.centerLeft,
        child: Padding(
          padding: EdgeInsets.only(top: 15.px, bottom: 3.px, left: 10.px),
          child: InkWell(
            onTap: () {
              niyamViewModel!.selectedIndex = 3;
              niyamViewModel!.sadgranthVachan = !niyamViewModel!.sadgranthVachan;
              controller.update();
            },
            child: Container(
              height: 31.px,
              ...
              child: Row(
                ...
                children: [
                  AppText(
                    textAlign: TextAlign.center,
                    text: niyamViewModel!.categoryList[3].catName,
                    fontSize: 16.px,
                    fontWeight: FontWeight.w600,
                    fontColor: BhajanColorConstant.white,
                  ),
                  Icon(
                    niyamViewModel!.sadgranthVachan
                        ? Icons.keyboard_arrow_up
                        : Icons.keyboard_arrow_down,
                    color: BhajanColorConstant.white,
                  )
      ...
      niyamViewModel!.sadgranthVachan == true
          ? sadgranthVachanBodyView()
          : const SizedBox(),
    ],
  );
}
